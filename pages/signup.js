  ...
  <div className="max-w-md w-full space-y-8">
    ...
    <form className="mt-8 space-y-6" action="#" method="POST">
      ...
      <div className="rounded-md shadow-sm -space-y-px">
        <div>
          <label for="name-address" className="sr-only">Name</label>
          <input id="name-address" name="name" type="text" autocomplete="name" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 focus:z-10 sm:text-sm" placeholder="Your Name" />
        </div>
        <div>
